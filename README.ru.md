...
Опциональная вытяжка выбирается как `fan` или `switch`. Она не заменяет PID окна и не меняет расчёт позиции. По температуре она помогает воздухообмену, когда окно уже достаточно открыто, а естественной тяги не хватает. По CO₂ она может включиться принудительно на время активного CO₂-проветривания.
